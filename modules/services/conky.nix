  ...
  config = {
    ...
    systemd.user.services =
      let
        ...
        configFile =
          filename: maybeConf:
          if lib.isPath maybeConf then
            maybeConf
          else
            pkgs.writeText filename maybeConf;
          ...
          (name: conf:
            {
              ...
              value = {
                ...
                Service = {
                  Restart = "always";
                  RestartSec = "3";
                  ExecStart = "${conf.package}/bin/conky --config ${configFile "conky-${name}.conf" conf.config}";
                };
          ...
          conky = {
            ...
            Service = {
              ...
              ExecStart = toString ([ "${cfg.package}/bin/conky" ]
                ...
                "--config ${configFile "conky.conf" cfg.extraConfig}");
            };
